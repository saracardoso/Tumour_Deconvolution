...
ground_truth_file_wOther = './Data/bulk/CRC/NICs/data/new_metadata/cell_proportions.csv'
ground_truth_file_woOther = './Data/bulk/CRC/NICs/data/new_metadata/cell_proportions_woOthers.csv'

ground_truth = read.csv(ground_truth_file_wOther, row.names=1)
ground_truth_woOther = read.csv(ground_truth_file_woOther, row.names=1)
...
write.csv(rmses, './Results/2_Default_Parameters/metrics/average_rmses.csv')
write.csv(rmses_samples_df, './Results/2_Default_Parameters/metrics/samples_rmses.csv')
write.csv(rmses_cellTypes_df, './Results/2_Default_Parameters/metrics/cellTypes_rmses.csv')
...
write.csv(corrs, './Results/2_Default_Parameters/metrics/average_correlations.csv')
write.csv(correlations_samples_df, './Results/2_Default_Parameters/metrics/samples_correlations.csv')
write.csv(correlations_cellTypes_df, './Results/2_Default_Parameters/metrics/cellTypes_correlations.csv')
