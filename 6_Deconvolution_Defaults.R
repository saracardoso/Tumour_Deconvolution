...
references = list()
references$uncorrected = read_scRNAseq_reference('./Data/CRC_reference/new/UB_matrix_CSV.csv',
                                                 './Data/CRC_reference/new/metadata.csv')
invisible(gc())
references$corrected = read_scRNAseq_reference('./Data/CRC_reference/new/B_matrix_CSV.csv',
                                               './Data/CRC_reference/new/metadata.csv')
invisible(gc())

# 2.2. Gene Markers:
markers =  jsonlite::read_json('./Data/CRC_reference/new/markers.json', simplifyVector=T)

# 2.3. Scaden train file:
scaden_train_files = list()
scaden_train_files$corrected = list()
scaden_train_files$corrected$wProl = './Data/CRC_reference/new/B_Scaden.h5ad'
scaden_train_files$corrected$woProl = './Data/CRC_reference/new/B_Scaden_woProl.h5ad'
scaden_train_files$uncorrected = list()
scaden_train_files$uncorrected$wProl = './Data/CRC_reference/new/UB_Scaden.h5ad'
scaden_train_files$uncorrected$woProl = './Data/CRC_reference/new/UB_Scaden_woProl.h5ad'

# 2.4. RNA bias correction vector
rna_correction_df = read.csv('./Data/CRC_reference/new/bias_values.csv', row.names=1)
...
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/AutoGeneS_linear.csv')
# 1.1.2. autogenes_nnls
res = Estimate.Proportions(CRC_bulk, references$uncorrected, 'Deconv_cellTypes', 'AutoGeneS',
                           model='nnls', gene.markers=markers)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/AutoGeneS_nnls.csv')
# 1.1.3. autogenes_nusvr
res = Estimate.Proportions(CRC_bulk, references$uncorrected, 'Deconv_cellTypes', 'AutoGeneS',
                           model='nusvr', gene.markers=markers)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/AutoGeneS_nusvr.csv')
...
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/woProl_AutoGeneS_linear.csv')
# 1.2.2. autogenes_nnls
res = Estimate.Proportions(CRC_bulk, list(data=references$uncorrected$data[, notprol_Tcells],
                                      metadata=references$uncorrected$metadata[notprol_Tcells,]),
                           'Deconv_cellTypes', 'AutoGeneS', model='nnls', gene.markers=markers)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/woProl_AutoGeneS_nnls.csv')
# 1.2.3. autogenes_nusvr
res = Estimate.Proportions(CRC_bulk, list(data=references$uncorrected$data[, notprol_Tcells],
                                      metadata=references$uncorrected$metadata[notprol_Tcells,]),
                           'Deconv_cellTypes', 'AutoGeneS', model='nusvr', gene.markers=markers)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/woProl_AutoGeneS_nusvr.csv')
...
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/BisqueRNA.csv')
# 2.1.2. With correction before
res = Estimate.Proportions(CRC_bulk, references$corrected, 'Deconv_cellTypes', 'BisqueRNA',
                                gene.markers=markers, use.overlap=FALSE, old.cpm=TRUE)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_before/BisqueRNA.csv')
# 2.1.3. With correction after
res = Estimate.Proportions(CRC_bulk, references$uncorrected, 'Deconv_cellTypes', 'BisqueRNA',
                                gene.markers=markers, use.overlap=FALSE, old.cpm=TRUE)
invisible(gc())
res = correct_fractions_mRNABias(res, rna_correction_vec)
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/BisqueRNA.csv')
...
res = Estimate.Proportions(CRC_bulk, list(data=references$uncorrected$data[, notprol_Tcells],
                           ...
                           old.cpm=TRUE)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/woProl_BisqueRNA.csv')
...
res = Estimate.Proportions(CRC_bulk, list(data=references$corrected$data[, notprol_Tcells],
                           ...
                           gene.markers=markers, use.overlap=FALSE, old.cpm=TRUE)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_before/woProl_BisqueRNA.csv')
...
invisible(gc())
res = correct_fractions_mRNABias(res, rna_correction_vec)
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/woProl_BisqueRNA.csv')
...
# 3.1.1. Uncorrected
res = read.csv('./Results/2_Default_Parameters/proportions/uncorrected/BSeqSC.csv', row.names=1)
rownames(res) = gsub('[_]', ' ', rownames(res))
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/BSeqSC.csv')
# 3.1.2. Corected before
res = read.csv('./Results/2_Default_Parameters/proportions/corrected_before/BSeqSC.csv', row.names=1)
rownames(res) = gsub('[_]', ' ', rownames(res))
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_before/BSeqSC.csv')
# 3.1.3. Corrected after
res = read.csv('./Results/2_Default_Parameters/proportions/uncorrected/BSeqSC.csv', row.names=1)
rownames(res) = gsub('[_]', ' ', rownames(res))
res = correct_fractions_mRNABias(res, rna_correction_vec)
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/BSeqSC.csv')

# 3.2. Without proliferative Tcells:
# 3.2.1. Uncorrected
res = read.csv('./Results/2_Default_Parameters/proportions/uncorrected/woProl_BSeqSC.csv', row.names=1)
rownames(res) = gsub('[_]', ' ', rownames(res))
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/woProl_BSeqSC.csv')
# 3.2.2. Corrected before
res = read.csv('./Results/2_Default_Parameters/proportions/corrected_before/woProl_BSeqSC.csv', row.names=1)
rownames(res) = gsub('[_]', ' ', rownames(res))
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_before/woProl_BSeqSC.csv')
# 3.2.3. Corrected after
res = read.csv('./Results/2_Default_Parameters/proportions/uncorrected/woProl_BSeqSC.csv', row.names=1)
rownames(res) = gsub('[_]', ' ', rownames(res))
res = correct_fractions_mRNABias(res, rna_correction_vec)
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/woProl_BSeqSC.csv')
...
# 3.1. With proliferative Tcells:
# 3.1.1. Uncorrected
res = read.csv('./Results/2_Default_Parameters/proportions/uncorrected/CIBERSORTx.csv', row.names=1)
rownames(res) = gsub('[_]', ' ', rownames(res))
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/CIBERSORTx.csv')
# 3.1.2. Corected before
res = read.csv('./Results/2_Default_Parameters/proportions/corrected_before/CIBERSORTx.csv', row.names=1)
rownames(res) = gsub('[_]', ' ', rownames(res))
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_before/CIBERSORTx.csv')
# 3.1.3. Corrected after
res = read.csv('./Results/2_Default_Parameters/proportions/uncorrected/CIBERSORTx.csv', row.names=1)
rownames(res) = gsub('[_]', ' ', rownames(res))
res = correct_fractions_mRNABias(res, rna_correction_vec)
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/CIBERSORTx.csv')

# 3.2. Without proliferative Tcells:
# 3.2.1. Uncorrected
res = read.csv('./Results/2_Default_Parameters/proportions/uncorrected/woProl_CIBERSORTx.csv', row.names=1)
rownames(res) = gsub('[_]', ' ', rownames(res))
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/woProl_CIBERSORTx.csv')
# 3.2.2. Corrected before
res = read.csv('./Results/2_Default_Parameters/proportions/corrected_before/woProl_CIBERSORTx.csv', row.names=1)
rownames(res) = gsub('[_]', ' ', rownames(res))
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_before/woProl_CIBERSORTx.csv')
# 3.2.3. Corrected after
res = read.csv('./Results/2_Default_Parameters/proportions/uncorrected/woProl_CIBERSORTx.csv', row.names=1)
rownames(res) = gsub('[_]', ' ', rownames(res))
res = correct_fractions_mRNABias(res, rna_correction_vec)
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/woProl_CIBERSORTx.csv')
...
invisible(gc())
write.csv(ddls_res$proportions, './Results/2_Default_Parameters/proportions/uncorrected/DigitalDLSorter.csv')
saveRDS(ddls_res$model_DDLS,
        '/home/scardoso/Documents/PhD/Tumour_Deconvolution/Results/2_Default_Parameters/DigitalDLSorter_models/uncorrected.Rdata')
...
ddls_res = Estimate.Proportions(CRC_bulk, references$corrected, 'Deconv_cellTypes', 'DigitalDLSorter', return.model=TRUE,
                                ...
                                batch.size=128, threads=6)
invisible(gc())
write.csv(ddls_res$proportions, './Results/2_Default_Parameters/proportions/corrected_before/DigitalDLSorter.csv')
saveRDS(ddls_res$model_DDLS,
        '/home/scardoso/Documents/PhD/Tumour_Deconvolution/Results/2_Default_Parameters/DigitalDLSorter_models/corrected.Rdata')
# 5.1.3. With correction after
res = read.csv('./Results/2_Default_Parameters/proportions/uncorrected/DigitalDLSorter.csv', row.names=1)
res = correct_fractions_mRNABias(res, rna_correction_vec)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/DigitalDLSorter.csv')
...
ddls_res = Estimate.Proportions(CRC_bulk, list(data=references$uncorrected$data[, notprol_Tcells],
                                ...
                                batch.size=128, threads=6)
invisible(gc())
write.csv(ddls_res$proportions, './Results/2_Default_Parameters/proportions/uncorrected/woProl_DigitalDLSorter.csv')
saveRDS(ddls_res$model_DDLS,
        '/home/scardoso/Documents/PhD/Tumour_Deconvolution/Results/2_Default_Parameters/DigitalDLSorter_models/woProl_uncorrected.Rdata')
...
ddls_res = Estimate.Proportions(CRC_bulk, list(data=references$corrected$data[, notprol_Tcells],
                                ...
                                batch.size=128, threads=6)
invisible(gc())
write.csv(ddls_res$proportions, './Results/2_Default_Parameters/proportions/corrected_before/woProl_DigitalDLSorter.csv')
saveRDS(ddls_res$model_DDLS,
        '/home/scardoso/Documents/PhD/Tumour_Deconvolution/Results/2_Default_Parameters/DigitalDLSorter_models/woProl_corrected.Rdata')
# 5.2.3. With correction after
res = read.csv('./Results/2_Default_Parameters/proportions/uncorrected/woProl_DigitalDLSorter.csv', row.names=1)
res = correct_fractions_mRNABias(res, rna_correction_vec)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/woProl_DigitalDLSorter.csv')
...
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/DWLS.csv')
# 6.1.2. With correction after
res = Estimate.Proportions(CRC_bulk, references$uncorrected, 'Deconv_cellTypes', 'DWLS', 0.5, 0.01,
                           rna.bias=FALSE, bias.vec=NULL)
invisible(gc())
res = correct_fractions_mRNABias(res, rna_correction_vec)
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/DWLS.csv')
...
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/woProl_DWLS.csv')
...
invisible(gc())
res = correct_fractions_mRNABias(res, rna_correction_vec)
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/woProl_DWLS.csv')
...
res = Estimate.Proportions(CRC_bulk, references$uncorrected, 'Deconv_cellTypes', 'MOMF', 'KL', 2,
                           1000, FALSE, NULL)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/MOMF.csv')
# 7.1.2. With before
res = Estimate.Proportions(CRC_bulk, references$corrected, 'Deconv_cellTypes', 'MOMF', 'KL', 2,
                           1000, FALSE, NULL)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_before/MOMF.csv')
# 7.1.3. With after
res = Estimate.Proportions(CRC_bulk, references$corrected, 'Deconv_cellTypes', 'MOMF', 'KL', 2,
                           1000, FALSE, NULL)
invisible(gc())
res = correct_fractions_mRNABias(res, rna_correction_vec)
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/MOMF.csv')
...
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/woProl_MOMF.csv')
# 7.2.2. With before
res = Estimate.Proportions(CRC_bulk, list(data=references$corrected$data[, notprol_Tcells],
                                          metadata=references$corrected$metadata[notprol_Tcells,]),
                           'Deconv_cellTypes', 'MOMF', 'KL', 2, 1000, FALSE, NULL)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_before/woProl_MOMF.csv')
# 7.2.3. With after
res = Estimate.Proportions(CRC_bulk, list(data=references$uncorrected$data[, notprol_Tcells],
                                          metadata=references$uncorrected$metadata[notprol_Tcells,]),
                           'Deconv_cellTypes', 'MOMF', 'KL', 2, 1000, FALSE, NULL)
invisible(gc())
res = correct_fractions_mRNABias(res, rna_correction_vec)
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/woProl_MOMF.csv')
...
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/MuSiC_woGrouping.csv')
...
res = Estimate.Proportions(CRC_bulk, list(data=references$uncorrected$data[, notprol_Tcells],
                           ...
                           wo.bias.vec=rna_correction_vec)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/woProl_MuSiC_woGrouping.csv')
...
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/MuSiC_wGrouping.csv')
# 9.1.2. With before
res = Estimate.Proportions(CRC_bulk, references$corrected, 'Deconv_cellTypes', 'MuSiC', music.method='with.Grouping', n.iterations=1000,
                           ...
                           w.markers.only.Pos=TRUE)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_before/MuSiC_wGrouping.csv')
# 9.1.3. With after
res = Estimate.Proportions(CRC_bulk, references$uncorrected, 'Deconv_cellTypes', 'MuSiC', music.method='with.Grouping', n.iterations=1000,
                           center=FALSE, normalize=FALSE, w.celltypes.Cluster.List=clusters, w.markers.log2FC=.8, w.markers.pval=.01,
                           w.markers.only.Pos=TRUE)
invisible(gc())
res = correct_fractions_mRNABias(res, rna_correction_vec)
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/MuSiC_wGrouping.csv')
...
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/woProl_MuSiC_wGrouping.csv')
# 9.2.2. With before
res = Estimate.Proportions(CRC_bulk, list(data=references$corrected$data[, notprol_Tcells],
                                          metadata=references$corrected$metadata[notprol_Tcells,]),
                           'Deconv_cellTypes', 'MuSiC', music.method='with.Grouping', n.iterations=1000, center=FALSE, normalize=FALSE, 
                          w.celltypes.Cluster.List=clusters_woProl, w.markers.log2FC=.8, w.markers.pval=.01, w.markers.only.Pos=TRUE)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_before/woProl_MuSiC_wGrouping.csv')
# 9.2.3. With after
res = Estimate.Proportions(CRC_bulk, list(data=references$uncorrected$data[, notprol_Tcells],
                                          metadata=references$uncorrected$metadata[notprol_Tcells,]),
                           'Deconv_cellTypes', 'MuSiC', music.method='with.Grouping', n.iterations=1000, center=FALSE, normalize=FALSE,
...
invisible(gc())
res = correct_fractions_mRNABias(res, rna_correction_vec)
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/woProl_MuSiC_wGrouping.csv')
...
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/Scaden.csv')
...
rownames(res)[3] = 'Macro/mono Lineage'
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_before/Scaden.csv')
...
res = correct_fractions_mRNABias(res, rna_correction_vec)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/Scaden.csv')
...
rownames(res)[3] = 'Macro/mono Lineage'
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/woProl_Scaden.csv')
...
rownames(res)[3] = 'Macro/mono Lineage'
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_before/woProl_Scaden.csv')
...
res = correct_fractions_mRNABias(res, rna_correction_vec)
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/woProl_Scaden.csv')
...
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/SCDC.csv')
# 11.1.2. With correction before
res = Estimate.Proportions(CRC_bulk, references$corrected, 'Deconv_cellTypes', 'SCDC',
                           scdc.method='multiple', n.iterations=1000, m.use.gridSearch=FALSE,
                           m.search.length=0.05, m.dataset.var='Dataset', m.weights.method='LAD')
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_before/SCDC.csv')
...
invisible(gc())
res = correct_fractions_mRNABias(res, rna_correction_vec)
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/SCDC.csv')
...
res = Estimate.Proportions(CRC_bulk, list(data=references$uncorrected$data[, notprol_Tcells],
                           ...
                           m.search.length=0.05, m.dataset.var='Dataset', m.weights.method='LAD')
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/uncorrected/woProl_SCDC.csv')
...
res = Estimate.Proportions(CRC_bulk, list(data=references$corrected$data[, notprol_Tcells],
                           ...
                           m.search.length=0.05, m.dataset.var='Dataset', m.weights.method='LAD')
invisible(gc())
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_before/woProl_SCDC.csv')
...
invisible(gc())
res = correct_fractions_mRNABias(res, rna_correction_vec)
write.csv(res, './Results/2_Default_Parameters/proportions/corrected_after/woProl_SCDC.csv')
